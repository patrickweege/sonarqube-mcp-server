...
class ListLanguagesToolTests {
  ...
  class WithServer {
    ...
    @SonarMcpServerTest
    void it_should_return_the_languages_list(SonarMcpServerTestHarness harness) {
    ...
    @SonarMcpServerTest
    void it_should_return_the_languages_list_with_query(SonarMcpServerTestHarness harness) {
